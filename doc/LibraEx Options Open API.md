...
The base url of LibraEx open API is: https://www.libraex.xin/openapi
...
In the `symbols` field, the endpoint will return information on current actively trading cryptos on LibraEx. You can ignore this section.
